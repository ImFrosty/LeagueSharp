...
namespace Mini_Brand
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Notifications.AddNotification("Mini Brand!", 10000);
            Game.PrintChat("<font color=\"#00FFFF\">Mini Brand by Frosty</font> - <font color=\"#00FFFF\">Loaded!</font>");
        }
